...
<tr>
  ...
  <th><?php echo $gpayment;?></th>
               ...
               <td>  
                ...
                {
                  echo ' <button type="button" class="btn btn-primary" disabled="" data-toggle="modal" data-target="#myModal">Track Action</button>';

                }
                else{
echo ' <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">Track Action</button>';                }
